...
class DoctorLocationWidget extends StatelessWidget {
  ...
  Set<Marker> marker;
  void _openMap() async {
    // Replace lat and long with your desired latitude and longitude
    String latitude = widget.doctor['location'].latitude.toString();
    String longitude = widget.doctor['location'].longitude.toString();

    // The URL format to open the map with specific latitude and longitude
    String url =
